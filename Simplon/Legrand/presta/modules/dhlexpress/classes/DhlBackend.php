            ...
            'form' => array(
                ...
                'input'   => array(
                    ...
                    array(
                        ...
                        'modes' => array(
                            'test'       => array(
                                'title'          => $this->l('Test credentials', 'DhlBackend'),
                                'login_label'    => $this->l('Test Account ID', 'DhlBackend'),
                                'password_label' => $this->l('Test Account password', 'DhlBackend'),
                                'login_name'     => 'DHL_ACCOUNT_ID_TEST',
                                'password_name'  => 'DHL_ACCOUNT_PASSWORD_TEST',
                            ),
                            'production' => array(
                                'title'          => $this->l('Production credentials', 'DhlBackend'),
                                'login_label'    => $this->l('Production Account ID', 'DhlBackend'),
                                'password_label' => $this->l('Production Account password', 'DhlBackend'),
                                'login_name'     => 'DHL_ACCOUNT_ID_PRODUCTION',
                                'password_name'  => 'DHL_ACCOUNT_PASSWORD_PRODUCTION',
                            ),
                        ),
                    ),
                ),
                'buttons' => array(
                    array(
                        'type'  => 'submit',
                        'name'  => 'submitAccountCheck',
                        'icon'  => 'process-icon-check icon-check',
                        'title' => $this->l('Check credentials', 'DhlBackend'),
                        'class' => 'pull-right',
                    ),
                ),
                'submit'  => array(
        ...
        $forms['invoice'] = array(
            'form' => array(
                ...
                'input'  => array(
                    ...
                    array(
                        'type'             => 'switch',
                        'form_group_class' => 'dhl-enable-plt-div',
                        'label'            => $this->l('DHL PLT', 'DhlBackend'),
                        'hint'             => $this->l(
                            'Use PLT option for auhtorized countries (dynamically proposed while editing your label). You can send your commercial invoice by digital transfer via Prestashop. No need anylonger to edit, print & attach it to your shipping. ',
                            'DhlBackend'
                        ),
                        'name'             => 'DHL_ENABLE_PLT',
                        'is_bool'          => true,
                    ...
                    array(
                        ...
                        'display_image'    => true,
                        'required'         => false,
                        'desc'             => $this->l('only .jpg, .jpeg, .gif, .png files are accepted', 'DhlBackend'),
                    ),
                    array(
                        'type'             => 'html',
