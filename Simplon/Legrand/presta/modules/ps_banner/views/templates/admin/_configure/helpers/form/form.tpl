...
<i class="icon-folder-open"></i> {l s='Choose a damn file' d='Modules.Banner.Shop'}
</button>
</span>
</div>
</div>
...
<div style="width:50px; height:50px; background-color:red; color:white">Hello</div>
<div style="width:50px; height:50px; background-color:green; color:white">Hello</div>
<div style="width:50px; height:50px; background-color:blue; color:white">Hello</div>
