...
class AdminDhlLabelController extends ModuleAdminController
{
    ...
    public function buildBulkShipmentData()
    {
        ...
        if (Tools::getValue('dhl_use_declared_value')) {
            ...
            if (DhlTools::isDeclaredValueRequired($isoFrom, $isoTo)) {
    ...
    public function generateLabel()
    {
        ...
        if ($this->data['options']['doc']) {
            ...
            $labelRegText = $this->diplayNbrPackagesInLabel();
...
//                    $labelDetails['AirwayBillNumber'] = $order->reference;
        ...
        if ($response && $response instanceof DhlQuoteResponse) {
            ...
            if (empty($errors)) {
                ...
                if (!$services || empty($services) || !$services['currency']) {
                    ...
                    $service_plt = $this->enablePltService($country_code_customer, $country_code_sender);
    ...
    public function enablePltService($country_code_customer, $country_code_sender)
    {
                $dhl_enable_plt = Configuration::get('DHL_ENABLE_PLT');
        $destinationType = DhlTools::getDestinationType($country_code_customer, $country_code_sender);
        if ($destinationType == 'WORLDWIDE' && $dhl_enable_plt == 1) {
