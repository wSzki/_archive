...
/**
 * Class BrainifyApiAllOrdersModuleFrontController
 */
class BrainifyApiAllOrdersModuleFrontController extends ModuleFrontController
{
    /**
     *
     */
    ...
    {
        $this->page_name = 'brainifyapiallorders';
