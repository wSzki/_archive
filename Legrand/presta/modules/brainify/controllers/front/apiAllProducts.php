...
/**
 * Class BrainifyApiAllProductsModuleFrontController
 */
class BrainifyApiAllProductsModuleFrontController extends ModuleFrontController
{
    /**
     *
     */
    ...
    {
        $this->page_name = 'brainifyapiallproducts';
