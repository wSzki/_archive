...
/**
 * Class BrainifyApiCategoriesModuleFrontController
 */
class BrainifyApiCategoriesModuleFrontController extends ModuleFrontController
{
    /**
     *
     */
    ...
    {
        $this->page_name = 'brainifyapicategories';
