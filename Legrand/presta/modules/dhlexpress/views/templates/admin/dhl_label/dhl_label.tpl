            ...
            <div id="dhl-package-{$package_type.id_dhl_package|intval}" class="form-group dhl-packages"
              ...
              <div class="col-lg-4 col-lg-offset-3">
                ...
                <div class="col-lg-offset-3">
                  <a class="btn btn-xl btn-primary dhl-add-package" data-package="{$package_type.id_dhl_package|intval}"
                     href="#" id="dhl-add-new-package-{$package_type.id_dhl_package|intval}">
          ...
          {if isset($id_order) && $action != 'createreturn'}
            <div style="clear: both; display: none;" class="panel_plt panel col-lg-12" id="panel_plt">
              <div style="border-bottom: solid 1px #a0d0eb;margin-bottom: 15px;"><span style="line-height: 3;"
                                                                                       class="title_box">{l s='Use P.L.T. Option to save time and paper ! No need to attach physically your DHL commercial invoice, send it by electronic transmission : PaperLess Transfer' mod='dhlexpress'}</span>
              </div>
              <form>
                <input type="radio"
                       ...
                       onchange="usePltOption();"/> {l s='Use P.L.T. Option by editing commercial invoice here :' mod='dhlexpress'}
                <a onclick="displayFormInvoice();"
                   style="text-transform: none;margin-left: 30px;{*display: none;*}"
