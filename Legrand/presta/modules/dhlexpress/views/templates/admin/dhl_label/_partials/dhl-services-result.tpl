            ...
            {foreach $servicesLocal as $service}
              {if isset($available_services[$code_value])}
                  ...
                  <td>
                    ...
                    <input {if !$free_label && !$return_label} {if $service.GlobalProductCode == "P" || $service.GlobalProductCode == "E" || $service.GlobalProductCode == "Y" }onclick="displayPltOption({$service_plt});"{else} onclick="hiddePltOption();"{/if} {/if}
