...
$(document).ready(function () {
  ...
  $('.dhl-label-extracharge-insurance span').live('click', function () {
   ...
   $('.dhl-label-extracharge-dangerous-goods .btn_DG span, .dhl-extracharge-non-doc .btn_DG span').live('click', function () {
  ...
  $('.dhl-label-doc span').live('click', function () {
   ...
   $('.dhl_label_service').live('click', function () {
    toggleExtracharges();
  });
  $('#submit-dhl-label-prices').live('click', function () {
    resetFormPlt();
  });
   $('.dhl-label-extracharge-excepted span').live('click', function () {
    toggleExceptedQuantities();
  });
});
